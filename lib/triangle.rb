class Triangle
  ...
  def kind 
    ...
    if side_1_length + side_2_length < side_3_length || side_3_length + side_2_length < side_1_length || side_1_length + side_3_length < side_2_length || side_1_length <= 0 || side_2_length <= || side_3_length <=0 
        begin 
          raise TriangleError
